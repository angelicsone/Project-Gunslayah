...
class VoiceIt
	...
	{
        var response = myVoiceIt.createUser("developerUserId", "d0CHipUXOk");
		...
		catch (WebException ex)
		{
			if (ex.Status == WebExceptionStatus.ProtocolError){
				using (var response1 = (HttpWebResponse)ex.Response){
	...
	{
        var response = myVoiceIt.deleteUser("developerUserId", "d0CHipUXOk");
		...
		{
			if (ex.Status == WebExceptionStatus.ProtocolError){
				using (var responses = (HttpWebResponse)ex.Response){
